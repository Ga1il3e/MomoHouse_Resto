...
export default function Footer() {
  ...
  // House-picker CTA is portal-only — redundant once you're already on a house site
  const showHousePicker = pathname === '/';
  ...
  return (
    ...
    >
      {showHousePicker ? (
        <div
          className="border-b px-6 pb-10 pt-16 text-center md:px-10 md:pb-14 md:pt-24"
        ...
        >
          ...
          >
            <p
              className="font-editorial mb-2 uppercase"
              style={{
                fontSize: '0.7rem',
                letterSpacing: '0.3em',
                color: 'var(--primary)',
            ...
            {locations?.map((loc, i) => (
              ...
              >
                ...
                <span
                  ...
                  style={{
                    color:
                      i === 0 ? 'rgba(245,240,232,0.7)' : 'var(--primary)',
                  }}
                  aria-hidden="true"
                >
                  →
      ...
      <div
        className="overflow-hidden border-b py-8"
      ...
      <div className="flex flex-col items-center justify-between gap-4 px-6 py-6 sm:flex-row md:px-10">
        ...
        >
          ...
          <div className="flex flex-col leading-none">
            ...
            <span
              ...
              style={{ fontSize: '0.45rem', color: 'var(--primary)' }}
            >
              HOUSE
            </span>
          </div>
        ...
        <div className="flex items-center gap-6">
          <a
            ...
            aria-label="Momo House on Instagram"
          >
            INSTAGRAM
          </a>
          <a
            ...
            aria-label="Momo House on Facebook"
          >
            FACEBOOK
          </a>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <span style={{ color: 'rgba(245,240,232,0.15)', fontSize: '0.6rem' }}>
            ·
          </span>
          <a
            href="/cgv"
